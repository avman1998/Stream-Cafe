  ...
  return (
    <div className="cursor-pointer md:max-w-[250px] rounded-full">
      <img
        ...
        className="object-cover max-h-[250px] transition ease-in-out delay-150 hover:-translate-3 hover:scale-110 duration-300 "
      />
...
export default function Body() {
  ...
  async function getVideos() {
    const data = await fetch(
      `https://youtube.googleapis.com/youtube/v3/search?part=snippet&channelType=any&maxResults=50&q=${search}&videoType=any&key=${DATA_API}`
    );
